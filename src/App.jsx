...
function App() {
    ...
    const [data, setData] = useState({
        totalPokedex: 0,
        totalCapturados: 0,
        cantidadDeDiaFaltante: 0,
        tiempoDisponibleDiario: 0
    });
  ...
  return (
    <div className="App">
        ...
        <form className="App-form" onSubmit={handleSubmit}>
            ...
            <input type="number" id="totalPokedex" name="totalPokedex" placeholder={230}/>
            <label htmlFor="totalCapturados">Total de pokemons capturados</label>
            <input type="number" id="totalCapturados" name="totalCapturados" placeholder={167}/>
